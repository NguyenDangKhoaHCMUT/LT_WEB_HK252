...
<div class="row mb-30">
    <div class="col-12">
        <div class="row">
            <div class="col-md-6 col-lg-3 mb-20">
                <a href="/btl/adminProduct/index" class="card text-decoration-none" style="border: 1px solid #e5e7eb; border-radius: 12px; padding: 20px; transition: all 0.3s;">
                    <div class="text-center">
                        <i class="fas fa-box-open" style="font-size: 32px; color: #6366f1; margin-bottom: 10px;"></i>
                        <h6 class="mt-3 mb-0">Quản Lý Sản Phẩm</h6>
                        <small class="text-muted">Xem, tìm kiếm, thêm, sửa, xoá</small>
                    </div>
                </a>
            </div>

            <div class="col-md-6 col-lg-3 mb-20">
                <a href="/btl/adminOrder/index" class="card text-decoration-none" style="border: 1px solid #e5e7eb; border-radius: 12px; padding: 20px; transition: all 0.3s;">
                    <div class="text-center">
                        <i class="fas fa-cart-shopping" style="font-size: 32px; color: #f59e0b; margin-bottom: 10px;"></i>
                        <h6 class="mt-3 mb-0">Giỏ Hàng / Đơn Hàng</h6>
                        <small class="text-muted">Xem thông tin, cập nhật trạng thái</small>
                    </div>
                </a>
            </div>
