    ...
    <div class="container-fluid p-0">
        <div class="row g-0 min-vh-100">
            ...
            <div class="col-md-6 col-lg-7 d-none d-md-block bg-dark position-relative overflow-hidden">
                ...
                <img src="https://images.unsplash.com/photo-1498050108023-c5249f4df085?ixlib=rb-4.0.3&auto=format&fit=crop&w=1400&q=80" alt="TechStore Background" class="position-absolute w-100 h-100" style="object-fit: cover; object-position: center; opacity: 0.8;">
                <div class="position-absolute w-100 h-100" style="background: linear-gradient(to right, rgba(0,0,0,0.8), rgba(0,0,0,0.2));"></div>
                
                <div class="position-absolute top-50 start-0 translate-middle-y text-white px-5 ms-md-4 ms-lg-5" style="max-width: 600px;">
                    ...
                    <p class="lead fw-light text-light mb-0">Chúng tôi cung cấp các thiết bị công nghệ hiện đại, chất lượng cao với dịch vụ bảo hành tận tâm và uy tín nhất.</p>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-5 d-flex flex-column justify-content-center px-4 py-5 px-sm-5 bg-white">
                <div class="w-100 mx-auto" style="max-width: 420px;">
                    ...
                    <div class="text-center mb-5 d-md-none">
                        <a href="/btl/" class="text-decoration-none text-primary fs-2 fw-bold d-inline-flex align-items-center">
                    ...
                    <?php if (isset($_SESSION['flash_msg'])): ?>
                        <div class="alert alert-<?= $_SESSION['flash_type'] ?? 'info' ?> alert-dismissible fade show shadow-sm border-0 bg-<?= $_SESSION['flash_type'] ?? 'info' ?> bg-opacity-10 text-<?= $_SESSION['flash_type'] ?? 'info' ?>">
